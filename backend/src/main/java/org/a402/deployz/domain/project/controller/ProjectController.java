...
public class ProjectController {
	...
	public BaseResponse<HashMap<String, String>> portCheckList(@RequestParam("port1") String port1) {
		HashMap<String, String> portNumCheck = projectService.findPortNumCheckList(port1);
